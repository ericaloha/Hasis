...
void Consumer_ItemTree_MVCC_TEST(ProAndCon* itemQ_, const int load_flag_){
    ...
    if(conn.is_open()){
      std::cout<<"connect to postgresql by item successfully. dbname="<<conn.dbname()<<std::endl;
    }else{
      std::cout<<"connect to postgresql fail by item."<<std::endl;
      return ;
    }   
  //"create table item(
...
void Consumer_OrderlineTree_MVCC_TEST(ProAndCon* itemQ_, const int load_flag_){
    ...
    hostaddr=127.0.0.1 port=5432");
    if(conn.is_open()){
      std::cout<<"connect to postgresql by orderline successfully. dbname="<<conn.dbname()<<std::endl;
    }else{
      std::cout<<"connect to postgresql by orderline fail."<<std::endl;
      return ;
    }
...
void Consumer_CustomerTree_MVCC_TEST(ProAndCon* itemQ_, const int load_flag_){
    ...
    hostaddr=127.0.0.1 port=5432");
    if(conn.is_open()){
      std::cout<<"connect to postgresql by customer successfully. dbname="<<conn.dbname()<<std::endl;
    }else{
      std::cout<<"connect to postgresql by customer fail."<<std::endl;
      return ;
    } 
...
void Consumer_StockTree_MVCC_TEST(ProAndCon* itemQ_, const int load_flag_){
    ...
    hostaddr=127.0.0.1 port=5432");
    if(conn.is_open()){
      std::cout<<"connect to postgresql by stock successfully. dbname="<<conn.dbname()<<std::endl;
    }else{
      std::cout<<"connect to postgresql by stock fail."<<std::endl;
      return ;
    }
  ...
  if(load_flag_ == 1){
    ...
    while(1){
      ...
      if(KeyWordExist(cmd,1)){
        ...
        //str = "create table stock(pk1 int,pk2 int,lsn char(8), value1 char(16),value2 char(240),value3 char(8),value4 char(16),value5 char(8),value5 char(16),value6 char(50),PRIMARY KEY(pk1,pk2));";
        std::string str = "insert into stock(pk1, pk2, lsn, value1, value2, value3, value4, value5, value6) values(";
        str+=res[3]+",";
        str+=res[2];
        str+=",\'lsn\',\'";
        str+=res[4];
...
void Consumer_NewordersTree_MVCC_TEST(ProAndCon* itemQ_, const int load_flag_){
    ...
    hostaddr=127.0.0.1 port=5432");
    if(conn.is_open()){
      std::cout<<"connect to postgresql by neworders successfully. dbname="<<conn.dbname()<<std::endl;
    }else{
      std::cout<<"connect to postgresql by neworders fail."<<std::endl;
      return ;
    }
  ...
  if(load_flag_ == 1){
    ...
    while(1){
      ...
      if(KeyWordExist(cmd,1)){
        ...
        //str = "create table neworders(pk1 int,pk2 int,
        //                          pk3 int,lsn char(8), 
        //          value1 char(16),PRIMARY KEY(pk1,pk2,pk3));";
        std::string str = "insert into neworders(pk1, pk2, pk3, lsn, value1) values(";
        str+=res[4]+",";
        str+=res[3]+",";
        str+=res[2];
        str+=",\'lsn\',\'";
...
void Consumer_OrdersTree_MVCC_TEST(ProAndCon* itemQ_, const int load_flag_){
    ...
    hostaddr=127.0.0.1 port=5432");
    if(conn.is_open()){
      std::cout<<"connect to postgresql by orders successfully. dbname="<<conn.dbname()<<std::endl;
    }else{
      std::cout<<"connect to postgresql by orders fail."<<std::endl;
      return ;
    }
  ...
  if(load_flag_ == 1){
    ...
    while(1){
      ...
      if(KeyWordExist(cmd,1)){
        ...
        //str = "create table orders(pk1 int,pk2 int,pk3 int,
        //lsn char(8), value1 char(16),value2 char(20),value3 char(16),
        //value4 char(16),value5 char(16),PRIMARY KEY(pk1,pk2,pk3));";/
        
        std::string str = "insert into orders(pk1, pk2, pk3, lsn, value1, value2, value3, value4, value5) values(";
        str+=res[4]+",";
        str+=res[3]+",";
        str+=res[2];
        str+=",\'lsn\',\'";
...
//str = "create table history1(pk1 int,pk2 int,pk3 int,lsn char(8), value1 char(16),value2 char(16),value3 char(20),value4 char(8),value5 char(24),PRIMARY KEY(pk1,pk2,pk3));";
//str = "create table history2(pk1 int,pk2 int,lsn char(8), value1 char(16),value2 char(16),value3 char(16),value4 char(20),value5 char(8),value6 char(24),PRIMARY KEY(pk1,pk2));";
...
int main(int argc, char const *argv[])
{
  ...
  if(load==1){
    ...
    hostaddr=127.0.0.1 port=5432");
    if(conn.is_open()){
      std::cout<<"connect to postgresql by dispatcher successfully. dbname="<<conn.dbname()<<std::endl;
    }else{
      std::cout<<"connect to postgresql by dispatcher fail."<<std::endl;
      return 0;
    }
    pqxx::work txn1(conn);
    //1. create tables
    std::string str = "create table item(pk int primary key, lsn char(8), value1 char(16),value2 char(24),value3 char(8),value4 char(50))";
    txn1.exec(str.c_str());
    txn1.commit();
    //mysql_real_query(&mysql, str.c_str(), str.size());
    
    pqxx::work txn2(conn);
    str = "create table orderline(pk1 int,pk2 int,pk3 int,pk4 int, lsn char(8), value1 char(16),value2 char(16),value3 char(20),value4 char(16),value5 char(8),value6 char(24),PRIMARY KEY(pk1,pk2,pk3,pk4))";
    txn2.exec(str.c_str());
    txn2.commit();

    pqxx::work txn3(conn);
    //mysql_real_query(&mysql, str.c_str(), str.size()); 
    str = "create table customer(pk1 int,pk2 int,pk3 int,lsn char(8), value1 char(16),value2 char(2),value3 char(16),value4 char(20),value5 char(20),value6 char(20),value7 char(2),value8 char(9),value9 char(16),value10 char(20),value11 char(2),value12 char(16),value13 char(60),value14 char(14),value15 char(14),value16 char(16),value17 char(16),value18 char(100),PRIMARY KEY(pk1,pk2,pk3));";
    //mysql_real_query(&mysql, str.c_str(), str.size()); 
    txn3.exec(str.c_str());
    txn3.commit();
    ...
    pqxx::work txn6(conn);
    str = "create table neworders(pk1 int,pk2 int,pk3 int,lsn char(8), value1 char(16),PRIMARY KEY(pk1,pk2,pk3));";
    //mysql_real_query(&mysql, str.c_str(), str.size()); 
    txn6.exec(str.c_str());
    txn6.commit();
    
    pqxx::work txn7(conn);
    str = "create table orders(pk1 int,pk2 int,pk3 int,lsn char(8), value1 char(16),value2 char(20),value3 char(16),value4 char(16),value5 char(16),PRIMARY KEY(pk1,pk2,pk3));";
    //mysql_real_query(&mysql, str.c_str(), str.size()); 
    txn7.exec(str.c_str());
    txn7.commit();
    
    pqxx::work txn8(conn);
    str = "create table stock(pk1 int,pk2 int,lsn char(8), value1 char(16),value2 char(240),value3 char(8),value4 char(16),value5 char(16),value6 char(50),PRIMARY KEY(pk1,pk2));";
    //mysql_real_query(&mysql, str.c_str(), str.size()); 
    txn8.exec(str.c_str());
    txn8.commit();
    ...
    */
    std::cout<<"create tables ok."<<std::endl;
    conn.disconnect();
